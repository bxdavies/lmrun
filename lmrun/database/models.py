...
class Games(Base):
    ...
    black1 = Column(ForeignKey('property_status.id', ondelete='CASCADE', onupdate='CASCADE'), nullable=False, index=True, server_default=text("1"))
    black2 = Column(ForeignKey('property_status.id', ondelete='CASCADE', onupdate='CASCADE'), nullable=False, index=True, server_default=text("1"))
    black3 = Column(ForeignKey('property_status.id', ondelete='CASCADE', onupdate='CASCADE'), nullable=False, index=True, server_default=text("1"))
    black4 = Column(ForeignKey('property_status.id', ondelete='CASCADE', onupdate='CASCADE'), nullable=False, index=True, server_default=text("1"))
    ...
    black1_status = relationship('PropertyStatus', primaryjoin='Games.black1 == PropertyStatus.id')
    black2_status = relationship('PropertyStatus', primaryjoin='Games.black2 == PropertyStatus.id')
    black3_status = relationship('PropertyStatus', primaryjoin='Games.black3 == PropertyStatus.id')
    black4_status = relationship('PropertyStatus', primaryjoin='Games.black4 == PropertyStatus.id')
